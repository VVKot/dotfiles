...
nnoremap {
    "<Leader>jh", function() call_with_test_directory_as_cwd("TestSuite") end
}
nnoremap {
    "<Leader>jj", function() call_with_test_directory_as_cwd("TestFile") end
}
nnoremap {
    "<Leader>jk", function() call_with_test_directory_as_cwd("TestNearest") end
}
